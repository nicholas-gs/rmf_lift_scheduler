...
public:
	...
	/// \brief Get a reference to a lift's state. Matching is done using Equal_Type
...
std::unique_ptr<Database<State_Type, Hash_Type, Equal_Type>>
	Database<State_Type, Hash_Type, Equal_Type>::make(InputIterator first, InputIterator last)
{
